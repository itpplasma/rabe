program test_fourier_transform_over_label
    ...
    if (not_same(delta_A_o_1, fieldline_modes%delta_aspect_ratio%cos_coeffs(2), &
        ...
        print *, "-------------------------------------------------------------"
    print *, "test_fourier_transform_over_label failed: 1st delta_aspect_ratio cos mode"
    ...
    if (not_same(zeros, fieldline_modes%delta_aspect_ratio%sin_coeffs, &
                 abstol_in=abstol)) then
        print *, "-------------------------------------------------------------"
       print *, "test_fourier_transform_over_label failed: delta_aspect_ratio sin modes"
