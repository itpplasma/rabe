...
!>   1. init_from_chartmap initializes without error
...
!>   3. init_from_boozmn initializes without error
...
program test_booz_xform_chartmap
    ...
    type(boozer_field_t) :: field_chart
    type(boozer_field_t) :: field_booz
    ...
    ! Load chartmap field
    ! ----------------------------------------------------------------
    call field_chart%init_from_chartmap(chartmap_file)
    ...
    ! ----------------------------------------------------------------
    call field_booz%init_from_boozmn(boozmn_file)
