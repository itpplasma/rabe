...
contains
    ...
    !> \param n_eta number of evaluation points to compute trapped fraction integral
    !> \param dr_dAtheta converting lambda_LC to be used with gradients of label r
